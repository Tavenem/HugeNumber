...
namespace Tavenem.HugeNumbers.Test
{
    ...
    public class MathTests
    {
        ...
        public void CubeRootTest()
        {
            ...
            Assert.IsTrue(first.CubeRoot().IsNearlyEqualTo(second, HugeNumber.Milli));
        }
        ...
        public void LogarithmTest()
        {
            ...
            Assert.IsTrue(first.Ln().IsNearlyEqualTo(new HugeNumber(1791759469228, -12), new HugeNumber(1, -12)));
        }
